        ...
        <Stack /*content of left side*/ sx={{ width: "60%", gap: "3rem" }}>
          ...
          >
            ...
            <Stack
              ...
              onClick={() =>
                handleSnackbar(
                  "GitHub login feature is not implemented yet!",
                  "failure"
                )
              }
            >
          ...
          <Stack sx={{ gap: "0.8rem" }}>
            ...
            >
              <CiLock style={{ fontSize: "20px", color: "gray" }} />
              <TextField
            ...
            >
              <Stack /* Checkbox and remeber me */ sx={{ color: "#E1E5E7" }}>
                <Typography>Remember Me</Typography>
              </Stack>
              <Stack /* Forgetme */ sx={{ color: "#0759D7" }}>
          ...
          >
            ...
            <Typography sx={{ color: "#0759D7" }}>Create an Account</Typography>
          </Stack>
        </Stack>
      </Stack>
      <Stack
