...
```sh
sh jenkinsinstall.sh <micro-service-name> <git-HTTP-url-to-your-code>

#Example
sh jenkinsinstall.sh service-b [https://github.com/cesarvr/Spring-Boot.git](https://github.com/cesarvr/Spring-Boot.git)
```
...
```sh
 sh jenkinsbuild.sh my-java-app
```
...
```sh
 oc start-build bc/my-java-app --from-file=targetspring-boot-0.0.1-SNAPSHOT.jar --follow
```
...
Jolokia: Agent started with URL [https://10.130.3.218:8778/jolokia/](https://10.130.3.218:8778/jolokia/)
...
```sh
  sh jenkinsinstall.sh service-a [https://github.com/cesarvr/Spring-Boot.git](https://github.com/cesarvr/Spring-Boot.git)
  sh jenkinsinstall.sh service-b [https://github.com/cesarvr/Spring-Boot.git](https://github.com/cesarvr/Spring-Boot.git)
```
...
```sh
curl [http://service-b.route.com/ping](http://service-b.route.com/ping)
#Ping! Pong!
curl [http://service-a.route.com/ping](http://service-a.route.com/ping)
#Ping! Pong!
curl [http://service-b.route.com/ping](http://service-b.route.com/ping)
#Ping! Pong!
```
